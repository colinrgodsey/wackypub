...
func TestAside_ContextualAnswerAndNothingPersisted(t *testing.T) {
	...
	expected := map[string]bool{"session.jsonl": true, "MEMORY.md": true, "runtime.json": true, "AGENTS.md": true, AllowedAgentsFile: true, RootMarkerFile: true, SeqFileName: true}

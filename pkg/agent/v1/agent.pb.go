...
func (x *ReadSessionEventsResponse) GetRolledBack() bool {
	if x != nil {
		return x.RolledBack
	}
	return false
...
type SubscribeSessionResponse struct {
	...
	// rewound indicates that the requested since_seq cursor was invalid (below baseline_seq or above latest_seq).
	Rewound bool `protobuf:"varint,2,opt,name=rewound,proto3" json:"rewound,omitempty"`
...
func (x *SubscribeSessionResponse) GetRolledBack() bool {
	if x != nil {
		return x.RolledBack
	}
	return false
...
//     record with normalized newline termination.
//
...
const file_agent_proto_rawDesc = "" +
	...
	"\x0flatest_turn_seq\x18\x05 \x01(\x03R\rlatestTurnSeq\x12\x1f\n" +
	...
	"\arewound\x18\x02 \x01(\bR\arewound\x12%\n" +
	"\x0edropped_events\x18\x03 \x01(\x03R\rdroppedEvents\x12\x1f\n" +
